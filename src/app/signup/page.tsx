...
import { TextField, Button, Select, MenuItem, InputLabel, FormControl, FormHelperText, Container, Typography, Box, CircularProgress } from '@mui/material';
    ...
    const handleSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            axios
                ...
                .then((apiResponse) => {
                    setLoading(false); // إيقاف حالة التحميل بعد النجاح
                    if (apiResponse?.data?.message === 'success') {
                        console.log('success');
                        router.push('/home'); // توجيه المستخدم إلى الصفحة الرئيسية بعد التسجيل الناجح
                    }
                })
                .catch((error) => {
                    setLoading(false); // إيقاف حالة التحميل في حالة الخطأ أيضًا
